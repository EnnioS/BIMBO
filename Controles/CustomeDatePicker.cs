...
{
    public class CustomeDatePicker:DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = ResourceCalendarIcon.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = ResourceCalendarIcon.calendarDark;
                else calendarIcon = ResourceCalendarIcon.calendarWhite;
                this.Invalidate();
            }
        }
